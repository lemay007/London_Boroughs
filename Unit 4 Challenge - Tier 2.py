...
# To see if there are any missing va`lues, we should call the count() method on our DataFrame:
...
# #### In conclusion:
# We can assess that the top 15 boroughs in London have all accumulated over 20% in average price, and can therefore be presumed to be the most sought after boroughs. 
